//
//  SetupNightNotificationController.swift
//  Journal
//
...
class SetupNightNotificationController: UIViewController {
    // MARK: - Properties
    ...
    private func setData(){
        ...
        let time = standard.string(forKey: "end_your_day_time")
        ...
        if time != nil && !time!.isEmpty {
            ...
            labelTime.text = "10:00pm"
        }
        
        dailyReminderSwich.setOn(standard.bool(forKey: "end_your_day_switch"), animated: true)
    ...
    @IBAction func didTapBtnSetTime(_ sender: Any) {
        ...
        standard.setValue(strTime, forKey: "end_your_day_time")
